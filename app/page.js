  ...
  return (
    <>
      ...
      {successTost && (
        <div
          id="toast-simple"
          class="flex fixed items-center right-3 top-2 z-50 max-w-xs p-4 space-x-4 rtl:space-x-reverse text-gray-500 bg-white divide-x rtl:divide-x-reverse divide-gray-200 rounded-lg shadow dark:text-gray-200 dark:divide-gray-700 dark:bg-gray-900 dark:shadow-sm dark:shadow-gray-100"
          role="alert"
        >
          <svg
      ...
      {/* navigation Bar */}
      <nav className="w-full h-24 flex items-center justify-between px-20 bg-gradient-to-b from-black to-transparent">
        <div>
          <span className="cursor-default text-4xl">Portfolio</span>
        </div>
        <div>
          <ul className="flex items-center justify-evenly gap-10">
            <Link href="#" className=" transition-all duration-700 ease-in-out">
      ...
      {/* Intro Section */}
      <section className="container m-auto  py-28 flex justify-center">
        <div className=" w-full flex flex-col gap-3 justify-center items-center">
          <div className="text-7xl font-bold cursor-default">
            Vineet k. Chauhan
          </div>
          <div className="text-xl font-bold pl-4 cursor-default">
            Java{" "}
            <span
          ...
          <div className=" w-11/12 pb-5 text-sm font-mono flex items-center  text-gray-400 cursor-default text-center pl-4">
          ...
          <div className="flex gap-10">
            <Link
              ...
              className=" transition-all duration-700 ease-in-out"
            >
              <span className="flex gap-2 font-mono cursor-pointer px-5 py-2 border-2 border-white rounded-md hover:bg-gray-800">
                <span>Contact </span>
                <svg
      ...
      >
        ...
        <div className="w-11/12 m-auto my-5  py-10 flex flex-wrap items-start gap-8 justify-evenly">
          <div className="w-1/4 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <Image
              className="w-full"
            ...
            <div className="px-6 py-4 bg-gray-900">
              ...
              <p className="text-gray-200 font-thin min-h-12">
          ...
          <div className="w-1/4 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            ...
            <div className="px-6 py-4 bg-gray-900">
              <div className="font-bold text-xl mb-2">EMS Api</div>
              <p className="text-gray-200 font-thin min-h-12">
                BackEnd | Java | MySql
              </p>
            </div>
      ...
      >
        ...
        <div className="w-11/12 m-auto my-5  py-10 flex flex-wrap items-start gap-0.5 gap-y-5  justify-evenly">
          {/* java skills */}
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <Image
              ...
              height={300}
            />
            <div className="font-bold text-md pb-2 text-center">JAVA</div>
          </div>

          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <div className="m-4">
              <Image
                className="w-full aspect-square object-cover p-3 box-border   bg-white rounded-full"
            ...
            <div className="font-bold text-md pb-2 text-center">
              Spring Boot
            </div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <Image
              ...
              height={300}
            />
            <div className="font-bold text-md pb-2 text-center">Java Swing</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <Image
              ...
              height={300}
            />
            <div className="font-bold text-md pb-2 text-center">MySql</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <Image
              ...
              height={300}
            />
            <div className="font-bold text-md pb-2 text-center">C</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <Image
              ...
              height={300}
            />
            <div className="font-bold text-md pb-2 text-center">HTML</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            ...
            <div className="font-bold text-md pb-2 text-center">CSS</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <Image
              ...
              height={300}
            />
            <div className="font-bold text-md pb-2 text-center">JavaScript</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            ...
            <div className="font-bold text-md pb-2 text-center">React Js</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            ...
            <div className="font-bold text-md pb-2 text-center">Next Js</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            <Image
              ...
              height={300}
            />
            <div className="font-bold text-md pb-2 text-center">GitHub</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            ...
            <div className="font-bold text-md pb-2 text-center">Postman</div>
          </div>
          ...
          <div className="w-1/6 overflow-hidden shadow-lg hover:scale-110 duration-300 border-2 border-sky-600 shadow-black rounded-lg">
            ...
            <div className="font-bold text-md pb-2 text-center">Vs Code</div>
          </div>
        </div>
      </section>
      ...
      <section
        id="aboutSection"
        className="container mb-10 pb-5 backdrop-blur-2xl m-auto rounded-3xl shadow-lg shadow-black scroll-smooth "
      >
        <div className=" w-3/4 m-auto flex items-center justify-center py-3 border-b-2 border-sky-800 ">
          <span className="text-2xl text-sky-300 font-bold font-mono">
            ABOUT ME
        ...
        <div className=" m-auto my-5  py-10 flex items-start gap-8 justify-evenly">
      ...
      {/* Footer */}
      <nav className="w-full h-32 flex items-center justify-center px-20 bg-gradient-to-t from-black to-transparent">
        {/* <div>
          <span className="cursor-default text-4xl">Portfolio</span>
        </div>
        <div>
      ...
      <div class="fixed bottom-4 right-3 p-2">
        <ul class="">
          <li class="my-4">
            <a
              href="https://github.com/vineet-javadev"
              ...
              target="_blank"
              rel="noopener"
              class="w-min flex items-center  bg-white px-1 py-1 rounded-md text-black transition hover:scale-125 hover:no-underline"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
